...
`}</CodeBlock>
      ...
      <p>
        Please please please (let me get what I want), don't add <code>"noImplicitAny": false</code>{" "}
        to your config. This is one of the major ways that the typing system can be completely
        undermined by just a small amount of code. There really shouldn't be any <code>any</code>s
        in your codebase if you value the benefits of TypeScript.
      </p>
